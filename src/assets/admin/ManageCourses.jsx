...
const ManageCourses = () => {
    ...
    useEffect(() => {
                ...
                lessons_response.forEach((lesson) => {
                    let lessonItem = `
                        <li>
                            ...
                            <div>
                                <button type="button" aria-label="Edit lesson" onClick={() => showLesson(lesson.id)} className="btn btn-sm btn-primary btn-action">show</button>
                            </div>
                        </li>
                    `;
                    document.getElementById("courseContentList").innerHTML += lessonItem;
                });
            } catch (error) {
        ...
        document.querySelector(".add-lesson-form form").addEventListener("submit", async function (event) {
        ...
        document.getElementById("update-lesson").addEventListener("click", async function (event) {
        ...
        document.getElementById("remove-lesson").addEventListener("click", async function (event) {
            const lessonId = event.target.getAttribute("data-lesson-id");
            try {
        ...
        <div className="col-md-6">
          ...
          <div className="add-lesson-form">
            ...
            <form>
			  ...
			  <p>Lesson Content</p>
			  <CKEditorComponent className="App"/>
